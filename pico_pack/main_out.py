...
class pico_emb():
    ...
    def __init__(self, sim_mcu0=0):
        ...
        # 2402310 => this can fit both pico and pico W using the same name
        ...
        self.w_led.board_check()

        # ========= accessing of defined IO or other function should after
        # board check function and select proper setting for pin settings
