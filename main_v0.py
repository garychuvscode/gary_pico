...
231107: find out that only use input() is able to communicate with PC...
what the fuck XDD, is that easy, but you should know when seeing print()
is able to print on the terminal directly~ anyway, welcome to the PICO
start to build the PICO firmware after 3 weeks of researching, and finally
find out that what we just need is a input()...

enjoy and have fun with PICO in micropython
